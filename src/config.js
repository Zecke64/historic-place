...
//==============================================================================
	...
	case 'Building':
        ...
        if (data.building=='transformer_tower')
        return ['power',25];
        if (data['image']  || data['wikidata'] || data['wikipedia'] || data['website']|| data['heritage:website'] || data['url'] || data['wikimedia_commons'])
		return ['house',18];
		return ['null',1];
...
//==============================================================================
	...
	case 'Mineshaft':
		...
		switch (data['disused:man_made']) {

			case 'mineshaft':
				return ['mine-d',25];

	}
		switch (data['abandoned:man_made']) {
...
//==============================================================================
	...
	case 'Tower':
		...
		if (data['historic'] == 'water_tower' || data['man_made'] =='water_tower' || data['disused:man_made'] =='water_tower' || data['abandoned:man_made'] =='water_tower' || data['disused:railway'] =='water_tower' || data['abandoned:railway'] =='water_tower')
			return ['watertower',20];

		if (data['historic'] == 'lighthouse' || data['man_made'] =='lighthouse' || data['disused:man_made'] =='lighthouse' || data['abandoned:man_made'] =='lighthouse')
		...
		if (data['tower:type'] == 'defensive' && data.defensive == 'bergfried' && data.ruins =='yes' || data.defensive == 'donjon' && data.ruins =='yes' || data.defensive == 'keep' && data.ruins =='yes')
			return ['bergfried_r',25];

		if (data['tower:type'] == 'defensive' && data.defensive == 'bergfried' || data.defensive == 'donjon' || data.defensive == 'keep')
			return ['bergfried',25];
...
//==============================================================================
	...
	case 'Razed':
		...
		if ((data.man_made == 'adit' || data['razed:man_made'] =='adit' || data['historic'] =='razed:adit') && data.direction && zoom>=15)
			return ['stollen-or-razed', 20, 20, 'S'];

		if (data.man_made == 'adit' || data['razed:man_made'] =='adit' || data['historic'] =='razed:adit')
			return ['stollen-razed', 20];

		if (data.man_made == 'mine' || data['razed:man_made'] =='mine' || data['historic'] =='razed:mine')
			return ['mine-razed',25];

		if (data.man_made == 'mineshaft' || data['razed:man_made'] =='mineshaft' || data['historic'] =='razed:mineshaft' || data['historic'] =='razed:mine_shaft')
			return ['mine-razed',25];

		if (data.man_made == 'windmill' || data['razed:man_made'] =='windmill' || data['historic'] =='razed:windmill')
			return ['razed-windmill',25];

		if (data.man_made == 'watermill' || data['razed:man_made'] =='watermill' || data['historic'] =='razed:watermill')
...
//==============================================================================
	...
	case 'Kiln.image':
                ...
                if (data['abandoned:man_made'] == 'kiln' || data['disused:man_made'] =='kiln' || data['abandoned'] =='yes'|| data['disused'] =='yes' || data['historic'] =='charcoal_pile')
		return ['meileraus', 20];
		return ['meiler',20];
...
//==============================================================================
	...
	case 'City_wall':
	  if (data['image']  || data['wikidata'] || data['wikipedia'] || data['website']|| data['heritage:website'] || data['url'] || data['wikimedia_commons'] || data['heritage'])
		return ['wall',20];
...
//==============================================================================
	...
	case 'Railway.image':
		...
		if (data['historic:railway']  == 'halt' || data['historic:railway']  == 'station' || data['historic:railway']  == 'station_site' 
			|| data['historic:railway']  == 'railway_station' || data['railway:historic'] == 'halt' || data['railway:historic'] == 'station' ||
			data['railway:historic'] == 'station_site' || data['railway:historic'] == 'railway_station' || data['historic'] == 'railway_station'|| data['historic'] == 'station_site')

				return ['railway_station',20];

		if (data['historic:railway']  == 'narrow_gauge' || data['historic:railway']  == 'rail' || data['historic:railway']  == 'railway'
			|| data['railway:historic'] == 'narrow_gauge' || data['railway:historic'] == 'rail' ||
			data['railway:historic'] == 'railway' || data['historic'] == 'railway' || data['historic'] == 'rail' || data['railway'] == 'abandoned')
...
//==============================================================================
	...
	case 'Sonstiges.userinfo':
		...
		if (data.name=='historische Säule zum Pferdeanbinden')
			return 'pferd';
		if (data.historic=='cultural_site' && data.name =='Flachsrösten' || data.wikidata=='Q1426270' || data.wikidata=='Q1426255')
...
//------------------------------------------------------
	...
	case 'Kiln':
		...
		if (data.kiln=='bricks' || data.product=='bricks' || data.produce=='bricks' || data.kiln=='brick' || data.product=='brick' || data.produce=='brick') {
		types.push ("$$Ziegelei%%");
		break;
	}
...
//------------------------------------------------------
	...
	case 'Road':
		...
		if (data['historic']  == 'mule_path' || data['historic']  == 'packhorse_trail' || data['abandoned:historic']  == 'packhorse_trail' || data['abandoned:historic']  == 'mule_path') {
...
//------------------------------------------------------
	...
	case 'Razed':
		...
		if (data['demolished:historic'] =='citywalls' && data.name == 'Berliner Mauer') {
...
//------------------------------------------------------
	...
	if (types.length==0 && data.boundary=='protected_area') {
	...
	if (protected 	) attributes.push ("$$denkmalgeschützt%%");
...
function styleFromData (data, context) {
	if ( sprache == 'de' )
	var title = data['name:de'] || data.name|| data.old_name || data['historic:name'] || data.ref || null;
	if ( sprache == 'en' )
	var title = data['name:en'] || data.name|| data.old_name || data['historic:name'] || data.ref || null;
	var title = data['name:'+sprache] || data.name || data.old_name || data['historic:name'] || data.ref || null;
  //----------------------------------------------
  ...
  //----------------------------------------------
    ...
    if (data.building=='monastery' || data.building && data.amenity=='monastery' ||
    data.building && data.historic=='monastery'|| data.building && data['abandoned:historic']=='monastery'|| data.building && data.historic=='abbey') return {
    ...
    if (data.building=='church' || data.building=='cathedral' ||
  ...
  if (data.building || data.building=='yes' || data['building:part'] && data.heritage) return {
  ...
  if (data.historic=='citywalls' || data.barrier=='city_wall' || data.building=='castle_wall' || data.wall=='castle_wall'|| data.historic=='castle_wall'|| data['fortress:type']=='wall') return {
...
function styleFromData3 (data, context) {
  ...
  if (data.historic=='roman_road'|| data.historic=='road'|| data.historic=='hollow_way'|| data.historic=='Altstraße'|| data.historic=='altstraße'|| data.historic=='mule_path'|| data.historic=='packhorse_trail' || data['abandoned:historic']  == 'packhorse_trail' || data['abandoned:historic']  == 'mule_path') return {
